...
const hitachiFlash = [
  ...
  { name: "Hitachi VSP 5000 Series", image: "hitachi-vsp-5000.jpg", tag: "CURRENT · ENTERPRISE", desc: "현재 판매 중인 VSP 5200·5200H·5600·5600H 미션크리티컬 스토리지입니다.", specs: ["판매 모델: VSP 5200 · 5200H · 5600 · 5600H", "오픈시스템 · 메인프레임 통합", "2 · 4 · 6노드 아키텍처", "100% 데이터 가용성 · Active-Active DR"], link: "https://knowledge.hitachivantara.com/portal/app/portlets/results/viewsolution.jsp?solutionid=242403040002249&view=print" },
  { name: "Hitachi VSP E Series", image: "hitachi-vsp-e.jpg", tag: "CURRENT · HYBRID", desc: "현재 판매 중인 E590H와 E1090H Hybrid 모델을 업무 규모에 맞춰 구성합니다.", specs: ["판매 모델: VSP E590H · E1090H", "NVMe SSD와 HDD를 결합한 Hybrid 구성", "최대 65노드 Scale-out", "100% 데이터 가용성 · VSP 데이터 서비스"], link: "https://knowledge.hitachivantara.com/portal/app/portlets/results/viewsolution.jsp?solutionid=242403040002249&view=print" },
];

const hitachiNetwork = [
  { name: "VSP One File", image: "hitachi-vsp-one-file.webp", tag: "FILE · SCALE-OUT", desc: "클라우드와 컨테이너 환경의 비정형 데이터를 위한 고성능 네트워크 스토리지입니다.", specs: ["판매 모델: VSP One File 34 · 38", "NFS v2/v3/v4/v4.1 · SMB2/SMB3 · iSCSI · FTP", "10/25/100GbE 네트워크", "File 34 최대 4노드 · File 38 최대 8노드"], link: "https://www.his21.co.kr/his/product/digital_enterprise/storage/vsp_one_file.do" },
...
const maintenanceProducts = [
  { name: "VSP 5000 기존 모델", detailSlug: "vsp-5000-series", image: "hitachi-vsp-5000.jpg", tag: "MAINTENANCE · EOS", desc: "판매 종료된 VSP 5100·5100H·5500·5500H의 유지보수와 전환을 지원합니다.", specs: ["판매 종료: 2022-09-30", "업그레이드 종료: 2025-09-30", "서비스 종료 예정: 2027-09-30", "후속 제품: VSP One Block High End"], supportOnly: true },
  { name: "VSP E Series 기존 모델", detailSlug: "vsp-e-series", image: "hitachi-vsp-e.jpg", tag: "MAINTENANCE · EOS", desc: "판매 종료된 E590/E790 All-Flash와 E790H·E1090 AFA의 유지보수와 전환을 지원합니다.", specs: ["E590/E790 AFA 서비스: 2029-12-31까지", "E790H/E1090 AFA 서비스: 2031-03-31까지", "현재 판매: E590H · E1090H", "VSP One Block 전환 비교"], supportOnly: true },
  { name: "Hitachi VSP F Series", image: "hitachi-vsp-f.jpg", tag: "MAINTENANCE · EOS", desc: "판매 종료된 VSP F Series 구축 환경의 유지보수와 최신 제품 전환을 지원합니다.", specs: ["기존 구축 환경 점검", "부품·펌웨어·지원기간 확인", "데이터 마이그레이션", "VSP One Block 전환 설계"], supportOnly: true },
  { name: "Hitachi VSP G Series", image: "hitachi-vsp-g.jpg", tag: "MAINTENANCE · EOS", desc: "판매 종료된 VSP G Series 구축 환경의 유지보수와 최신 제품 전환을 지원합니다.", specs: ["기존 구축 환경 점검", "부품·펌웨어·지원기간 확인", "데이터 마이그레이션", "VSP One Block·E Series 전환 설계"], supportOnly: true },
  { name: "VSP One File 32", detailSlug: "vsp-one-file", image: "hitachi-vsp-one-file.webp", tag: "MAINTENANCE · EOS", desc: "판매 종료된 VSP One File 32의 기존 고객 지원과 File 34·38 전환을 제공합니다.", specs: ["판매 종료: 2025-04-28", "업그레이드 종료: 2025-04-28", "서비스 종료 예정: 2030-04-29", "후속 판매 모델: File 34 · 38"], supportOnly: true },
  { name: "Hitachi NAS Platform", image: "hitachi-nas-platform.jpg", tag: "MAINTENANCE · EOS", desc: "판매 종료된 HNAS 4060·4080·4100 구축 환경의 유지보수를 지원합니다.", specs: ["판매 종료: 2021-12-06", "업그레이드 종료: 2024-12-06", "서비스 종료 예정: 2026-12-31", "VSP One File·Unified 전환 설계"], supportOnly: true },
];
...
export default function StorageLineupPage() {
  ...
  <div className="bg-slate-50"><ProductSection code="HITACHI_MAINTENANCE" title="판매 종료 제품 유지보수" description="신규 판매가 종료됐지만 공식 서비스 기간이 남아 있는 Hitachi 스토리지의 유지보수, 증설 가능 여부 확인과 후속 제품 전환을 지원합니다." products={maintenanceProducts} /></div>
